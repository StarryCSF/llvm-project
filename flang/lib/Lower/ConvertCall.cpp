...
genProcedureRef(CallContext &callContext) {
  ...
  // Intercept module procedure references that have lowering handlers
  // defined for their name. Otherwise, lower them as user procedure calls
  // and expect the implementation to be part of runtime libraries with the
